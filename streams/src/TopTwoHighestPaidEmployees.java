...
public class TopTwoHighestPaidEmployees {
    public static void main(String[] args) {
        ...
        employees.stream().distinct().filter(employee -> employee.getSalary()>65000).limit(2).forEach(System.out::println);
        System.out.println();
        employees.stream().distinct().sorted(Comparator.comparingDouble(employee -> -1*employee.getSalary())).limit(2).forEach(System.out::println);
    }
}
